  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center items-center w-full">
        ...
        <button className="border-2 border-white text-white font-raleway font-bold py-2 px-4 mt-4 rounded-full hover:bg-white hover:text-[#4b0e1e] transition-all duration-300 ease-in-out" onClick={() => window.open(menu_pdf, '_blank')}>
          View Menus
        </button>
      </div>
    </div>
