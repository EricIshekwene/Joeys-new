  ...
  return (
    ...
    )}
    {
      !isLarge && (
        ...
        {/* Right Side Content */}
        <div className="w-full bg-[#f5f0e6] h-full flex flex-col justify-between gap-4 items-center p-6">
          {/* Status image (open/close sign) */}
          <img
            src={isOpen ? open_live_hours : close_live_hours}
            alt="live_hours_status"
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full flex flex-row justify-center gap-8">
              {/* Days */}
              <div className="text-lg md:text-xl font-raleway flex flex-col items-end gap-2">
                <span>Monday</span>
                <span>Tuesday</span>
                <span>Wednesday</span>
                <span>Thursday</span>
              ...
              {/* Hours */}
              <div className="text-lg md:text-xl  font-raleway flex flex-col items-start gap-2">
                <span>10:00 AM – 10:00 PM</span>
                <span>10:00 AM – 10:00 PM</span>
                <span>10:00 AM – 10:00 PM</span>
                <span>10:00 AM – 10:00 PM</span>
